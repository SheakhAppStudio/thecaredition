      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div className="flex items-center mb-6 md:mb-0">
            <span className="text-orange font-heading text-3xl font-bold">CAR</span>
            <span className="ml-1 font-heading text-2xl font-medium">EDITION</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services/paint-protection" className="text-gray-400 hover:text-white transition-colors">Paint Protection</Link></li>
